...
public class ScheduleDepartUnoServiceImpl  extends BaseServiceImpl<ScheduleDepartUno> implements ScheduleDepartUnoService{
	...
	*/
	public List<ScheduleDepartUno> queryDeptUinfo(Object objUser, ScheduleDepartUno query) {
		...
		String content = httpClientUtils.send("http://fx.dev.galaxyinternet.com/authority_service/depart/getLeafDepartList", map);
         ...
         for(int i=0;i<array.size();i++){
            ...
            Long deptTempId = Long.valueOf(ids);
 			...
 			//部门下所有人中 对已经选择的人标记
 			 ...
 			 String contentt = httpClientUtils.send("http://fx.dev.galaxyinternet.com/authority_service/user/getUsersByDepId", map); 			
	...
	public List<SharePerson> queryAppPerson(Object objUser, ScheduleDepartUno query) {
		...
		String content = httpClientUtils.send("http://fx.dev.galaxyinternet.com/authority_service/user/getUsersByKey", map);
