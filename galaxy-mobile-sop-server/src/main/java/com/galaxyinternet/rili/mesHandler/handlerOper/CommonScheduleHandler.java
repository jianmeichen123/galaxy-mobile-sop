...
public class CommonScheduleHandler implements ScheduleMessageHandler
{
	...
	private String add_com_schedule  = "1.3.1";
	private String edit_com_schedule = "1.3.2";
	private String del_com_schedule  = "1.3.3";
	
	
	private Map<String,String> map = new HashMap<String,String>();
	public CommonScheduleHandler(){
		map.put(add_com_schedule,  "新增   普通日程 （ 其它日程）");
		map.put(edit_com_schedule, "修改   普通日程 （ 其它日程）");
		map.put(del_com_schedule,  "删除   普通日程 （ 其它日程）");
	}
