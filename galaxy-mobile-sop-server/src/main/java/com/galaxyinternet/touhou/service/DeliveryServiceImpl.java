...
public class DeliveryServiceImpl extends BaseServiceImpl<Delivery> implements DeliveryService {
	...
	@Transactional
	public Page<DeliveryBo> queryDeliveryPageList(DeliveryBo query,Pageable pageable) {
		Page<DeliveryBo> page = deliveryDao.selectDeliveryPageList(query,pageable);
		...
		if(page!=null && page.getContent()!=null && !page.getContent().isEmpty()){
			...
			page = new Page<DeliveryBo>(new ArrayList<DeliveryBo>() , pageable, 0l);
		}
