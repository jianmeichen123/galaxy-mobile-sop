...
public enum IosMeaageOperation {
	...
	ADD_SCHEDULING			("/galaxy/project/updateReserveTimeByApp/"+ UrlNumber.one, 	PlatformConst.IOS_TITLE_MEET, "，请您准时参加，如对时间有疑问请联系相关负责人。"),
	UPDATE_SCHEDULING		("/galaxy/project/updateReserveTimeByApp/"+ UrlNumber.two, 	PlatformConst.IOS_TITLE_MEET, "，请您准时参加，如对时间有疑问请联系相关负责人。"),
	DELETE_SCHEDULING		("/galaxy/project/updateReserveTimeByApp/"+ UrlNumber.three, PlatformConst.IOS_TITLE_MEET, "，请您准时参加，如对时间有疑问请联系相关负责人。");
